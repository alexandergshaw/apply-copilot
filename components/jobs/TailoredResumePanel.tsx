  ...
  if (templates.length === 0) {
    return (
      <article className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">Upload a resume template before tailoring.</p>
        <Link
          href="/resumes"
